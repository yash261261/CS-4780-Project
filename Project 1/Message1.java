...
public class Message1 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		//read file
		Scanner msg1 = new Scanner(new File("/Users/Abdullah/Documents/workspace/msg1.txt"));
		
		String msg = "";
		
		//read through end of text file
		while(msg1.hasNext()){
			msg = msg1.next();
		}
		msg1.close();
		...
		for (int j = 0; j < 1023; j++) {
			...
			System.out.print("The 10-bit key used for encryption:");
			printArr(key);
